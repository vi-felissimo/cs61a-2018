...
def is_swap(score0, score1):
    ...
    # BEGIN PROBLEM 4
    if score0 in [1, 0] or score1 in [1, 0]:
        return False
    else:
        if score0 > score1:
            return not (score0 % score1)
        else:
            return not (score1 % score0)
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    >>> ff2 = f1(11, 1) # make sure there's no other side effect than print
    1 point! That's the biggest gain yet for Player 1 
    """
